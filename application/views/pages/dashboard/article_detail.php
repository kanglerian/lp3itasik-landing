<div class="container mx-auto overflow-x-auto px-2 mt-10">
  ...
  <form id="form" action="<?= base_url() ?>article/update/<?= $article->id ?>" class="flex flex-col md:items-start gap-4 py-3 px-2" method="post" enctype="multipart/form-data">
    <div class="flex flex-row items-center justify-center gap-5">
      <div class="flex-1 flex flex-col gap-2">
        <h1 class="font-bold text-2xl mb-3"><?= $article->title ?></h1>
      ...
      <div class="flex-1">
        <img src="<?= base_url() ?>uploads/<?= $article->image ?>" class="w-full rounded shadow border-8 border-white">
      </div>
    </div>
    <div class="w-full">
