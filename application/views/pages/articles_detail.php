	...
	<div class="container mx-auto px-4">
		<div class="flex flex-col justify-end md:flex-row gap-5">
			...
			<div class="w-full md:w-2/3">
				...
				<div class="space-y-5 mt-4 bg-gray-100 px-5 py-5 rounded-xl">
					...
					<a target="_blank" href="<?= $article->source ?>" class="inline-block text-sm bg-sky-100 text-sky-700 px-3 py-1 rounded-lg"><i class="fa-solid fa-link"></i> Sumber</a>
				</div>
			</div>
		</div>
	</div>
