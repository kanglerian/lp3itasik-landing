	...
	<div class="container mx-auto px-4">
		<header class="mb-7 text-center">
			<a href="<?= base_url() ?>blogs/medias">
				<h1 class="text-3xl font-bold text-gray-700 hover:text-gray-800 underline underline-offset-8">Media Terbaru <i class="ml-2 fa-solid fa-circle-arrow-right"></i></h1>
			</a>
		</header>
		<?php if (!empty($medias)) { ?>
		...
		<header class="mb-7 text-center">
			<a href="<?= base_url() ?>blogs/articles">
				<h1 class="text-3xl font-bold text-gray-700 hover:text-gray-800 underline underline-offset-8">Artikel Terbaru <i class="ml-2 fa-solid fa-circle-arrow-right"></i></h1>
			</a>
		</header>
