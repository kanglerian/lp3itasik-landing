<section class="my-14">
	<div class="container mx-auto px-4">
		...
		<a href="<?= base_url() ?>blogs/articles"><h1 class="text-3xl font-bold text-gray-700 hover:text-gray-800 underline underline-offset-8">Artikel Terbaru <i class="ml-2 fa-solid fa-circle-arrow-right"></i></h1></a>
		</header>
		...
		<hr class="my-12">
		<header class="mb-7 text-center">
			<a href="<?= base_url() ?>blogs/medias"><h1 class="text-3xl font-bold text-gray-700 hover:text-gray-800 underline underline-offset-8">Media Terbaru <i class="ml-2 fa-solid fa-circle-arrow-right"></i></h1></a>
		</header>
		<?php if (!empty($medias)) { ?>
			<div class="w-full flex justify-center flex-wrap gap-5">
				<?php foreach ($medias as $media) { ?>
					<div class="item w-96 h-auto border-8 border-white shadow rounded-lg ease-in-out delay-50 md:hover:-translate-y-1 md:hover:scale-105 duration-300">
						...
						<div class="p-4 space-y-4">
							<h5 class="font-bold text-base mb-1 text-left text-gray-700"><?= substr($media->title, 0, 70) ?><?= strlen($media->title) >=70 ? '...' : '' ?></h5>
